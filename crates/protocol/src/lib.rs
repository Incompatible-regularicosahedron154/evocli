...
pub enum ToolCall {
    // 文件系统
    FsRead       { path: String },
    FsWrite      { path: String, content: String, dry_run: bool },
    FsApplyDiff  { path: String, diff: String, dry_run: bool },

    // Git
    GitStatus    {},
    GitCommit    { message: String, files: Vec<String> },
    GitSnapshot  {},
    GitRestore   { stash_ref: String },

    // Shell（受限，经过 SecurityController 白名单检查）
    ShellRun     { cmd: String, cwd: String, timeout_s: u32, dry_run: bool },
    ...
    // 搜索
    SearchCode   { query: String, path: Option<String> },

    // Code Intelligence
    CodeIntelIncomingCalls  { symbol: String },
    CodeIntelOutgoingCalls  { symbol: String },
    CodeIntelFullChain      { symbol: String, direction: String, max_depth: u32 },
    CodeIntelImpactRadius   { symbol: String },
    CodeIntelRankedContext  { modified_file: String, mentioned: Vec<String> },
    CodeIntelFindSymbol     { query: String, file: Option<String> },

    // Built-in AI 工具（Symbol Oracle / Assumption Verifier / Impact Probe / Equiv Finder）
    SymbolLookup     { name: String, file: Option<String> },
    SymbolVariants   { type_name: String },
    SymbolUsages     { symbol_id: String, limit: Option<u32> },
    AssumeVerify     { assumption: String, subject: String },
    AssumeIsPure     { symbol: String },
    AssumeHasTests   { symbol: String },
    ImpactCheck      { symbol: String, change_type: String },
    EquivFind        { intent: String, context: Option<String>, limit: Option<u32> },

    // Task Contract
    ContractCreate   { requirement: String },
    ContractVerify   { contract_id: String, run_tests: bool },
    CheckpointUpdate { checkpoint_id: String, status: String, evidence: Option<String> },
}
